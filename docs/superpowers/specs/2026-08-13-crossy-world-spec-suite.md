...
2. [Source asset catalog](../../ASSETS.md) — supplied packs, license status, production boundaries, curation, and conversion rules.
3. [Product and protocol design](./2026-08-13-crossy-world-design.md) — approved product rules and overall architecture.
4. [Contract and economy](./2026-08-13-crossy-world-contract-economy-spec.md) — durable accounts, instructions, custody, NFTs, gacha, marketplace, refunds, and settlement.
5. [MagicBlock gameplay and integration](./2026-08-13-crossy-world-magicblock-integration-spec.md) — delegated realtime accounts, sessions, grid simulation, hazards, VRF chunks, cranks, and cross-plane workflows.
6. [Frontend and Three.js](./2026-08-13-crossy-world-frontend-threejs-spec.md) — detailed React/Vite rendering, input, prediction, and asset architecture.
7. [Visual UI and motion design](./2026-08-13-lana-roads-visual-ui-motion-design.md) — detailed Voxel Arcade art direction and transitions.
8. [Client SDK, subscriptions, and indexing](./2026-08-13-crossy-world-sdk-indexing-spec.md) — typed client workflows, routing, realtime subscriptions, derived APIs, and indexer rules.
9. [Testing, security, and operations](./2026-08-13-crossy-world-testing-security-operations-spec.md) — verification, threat model, load gates, deployment, monitoring, reconciliation, and incident response.
10. [Coding-agent guide template](./crossy-world-AGENTS.template.md) — repository-level instructions and safety constraints for AI coding agents.
